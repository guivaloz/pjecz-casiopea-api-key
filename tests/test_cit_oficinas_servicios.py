...
class TestCitOficinasServicios(unittest.TestCase):
    ...
    def test_get_cit_oficinas_servicios_from_cjs_ajg(self):
        """Test GET cit_oficinas_servicios from oficina_clave CJS-AJG"""
        oficina_clave = "CJS-AJG"
        response = requests.get(
            url=f"{config['api_base_url']}/cit_oficinas_servicios",
            headers={"X-Api-Key": config["api_key"]},
            params={"oficina_clave": oficina_clave},
        ...
        for item in payload["data"]:
            ...
            self.assertEqual(item["oficina_clave"], oficina_clave)

    def test_get_cit_oficinas_servicios_from_cjs_ocp(self):
        """Test GET cit_oficinas_servicios from oficina_clave CJS-OCP"""
        oficina_clave = "CJS-OCP"
        response = requests.get(
            url=f"{config['api_base_url']}/cit_oficinas_servicios",
            headers={"X-Api-Key": config["api_key"]},
            params={"oficina_clave": oficina_clave},
